...
export const DEFAULT_DOCKER_IMAGE = 'rig-agent:latest';
export const PROJECT_DOCKER_IMAGE_PREFIX = 'rig-project:';
export const PROJECT_DOCKERFILE_RELATIVE_PATH = '.rig/Dockerfile';
